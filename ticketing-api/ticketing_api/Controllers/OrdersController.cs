...
namespace ticketing_api.Controllers
{
    ...
    public class OrdersController : BaseController.BaseController
    {
        ...
        // GET: api/Orders
        [HttpGet]
        public async Task<IActionResult> GetOrderAsync([FromQuery]SieveModel sieveModel)
        {
            var isPermisssion = await CheckPermissions("ORDERS", "Read");
        ...
        public async Task<IActionResult> ViewOrderAsync([FromQuery]SieveModel sieveModel)
        {
            ...
            PagingResults<OrderView> orderView = await _orderService.GetOrderViewAsync(AppUser,sieveModel);
            return Ok(orderView);
        }
        ...
        {
            var isPermisssion = await CheckPermissions("ORDERS", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("ORDERS", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("ORDERS", "Delete");
        ...
        public async Task<IActionResult> PostOrderTicketAsync([FromRoute] int id)
        {
            ...
            if (!isPermisssion)
            {
                return BadRequest("Create ticket from order permission not allowed");
            }
