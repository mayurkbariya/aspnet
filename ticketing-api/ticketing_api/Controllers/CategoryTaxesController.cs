...
namespace ticketing_api.Controllers
{
    ...
    public class CategoryTaxesController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("CATEGORYTAX", "Read");
        ...
        public async Task<IActionResult> GetCategoryTax([FromRoute] int id)
        {
            ...
            if (categoryTax == null)
            {
                return NotFound("CategoryTax Id not found");
            }
        ...
        {
            var isPermisssion = await CheckPermissions("CATEGORYTAX", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("CATEGORYTAX", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("CATEGORYTAX", "Delete");
