...
namespace ticketing_api.Controllers
{
    ...
    public class SalesRepsController : IdentityBaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("SALESREPS", "Read");
        ...
        // GET: api/SalesReps/5
        [HttpGet("{id}")]
        public async Task<IActionResult> GetSalesRep([FromRoute] int id)
        {
            var isPermisssion = await CheckPermissions("SALESREPS", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("SALESREPS", "Create");
            ...
            var driverNameExists = await _context.AppUser.FirstOrDefaultAsync(d => d.Id != salesRep.Id && d.FullName.ToLower() == fullName); // && d.Role=="Driver");
        ...
        {
            var isPermisssion = await CheckPermissions("SALESREPS", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("SALESREPS", "Delete");
