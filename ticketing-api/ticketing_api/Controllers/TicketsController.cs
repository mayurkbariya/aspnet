...
namespace ticketing_api.Controllers
{
    ...
    public partial class TicketsController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("TICKETS", "Read");
            ...
            var ticketView = await _orderService.GetOrderViewAsync(AppUser, sieveModel, true);
        ...
        public async Task<IActionResult> PostTicketOrder([FromRoute] int id)
        {
            ...
            if (!isPermisssion)
            {
                return BadRequest("Change ticket to order permission not allowed");
            }
        ...
        public async Task<IActionResult> VoidTicket([FromRoute] int id)
        {
            ...
            if (!isPermisssion)
            {
                return BadRequest("Change ticket to voidticket permission not allowed");
            }
        ...
        {
            var isPermisssion = await CheckPermissions("TICKETS", "Delete");
