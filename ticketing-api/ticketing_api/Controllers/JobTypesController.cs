...
namespace ticketing_api.Controllers
{
    ...
    public class JobTypesController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("JOBTYPES", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("JOBTYPES", "Create");
            ...
            if (jobTypeNameExists != null)
                return BadRequest("JobType already exists");
        ...
        {
            var isPermisssion = await CheckPermissions("JOBTYPES", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("JOBTYPES", "Delete");
