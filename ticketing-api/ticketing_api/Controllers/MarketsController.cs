...
namespace ticketing_api.Controllers
{
    ...
    public class MarketsController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("MARKETS", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("MARKETS", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("MARKETS", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("MARKETS", "Delete");
