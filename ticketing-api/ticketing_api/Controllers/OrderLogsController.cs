...
namespace ticketing_api.Controllers
{
    ...
    public class OrderLogsController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("ORDERSLOG", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("TICKETSLOG", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("CUSTOMERSLOG", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("RIGSLOG", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("ORDERSLOG", "Delete");
        ...
        {
            var isPermisssion = await CheckPermissions("TICKETSLOG", "Delete");
        ...
        {
            var isPermisssion = await CheckPermissions("CUSTOMERSLOG", "Delete");
        ...
        {
            var isPermisssion = await CheckPermissions("RIGSLOG", "Delete");
