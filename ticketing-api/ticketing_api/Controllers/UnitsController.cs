...
namespace ticketing_api.Controllers
{
    ...
    public class UnitsController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("UNITS", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("UNITS", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("UNITS", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("UNITS", "Delete");
