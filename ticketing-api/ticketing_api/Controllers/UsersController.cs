...
namespace ticketing_api.Controllers
{
    ...
    public class UserController : IdentityBaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("USERS", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("USERS", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("USERS", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("USERS", "Delete");
