...
namespace ticketing_api.Controllers
{
    ...
    public class TaxesController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("TAXES", "Read");
        ...
        public async Task<IActionResult> PostTaxAsync([FromBody] ProductTaxView productTaxView)
        {
            ...
            var isPermisssion = await CheckPermissions("TAXES", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("TAXES", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("TAXES", "Delete");
