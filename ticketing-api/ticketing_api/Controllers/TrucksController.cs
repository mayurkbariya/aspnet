...
namespace ticketing_api.Controllers
{
    ...
    public class TrucksController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("TRUCKS", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("TRUCKS", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("TRUCKS", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("TRUCKS", "Delete");
