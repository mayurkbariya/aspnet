...
namespace ticketing_api.Controllers
{
    ...
    public class PaymentTermsController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("PAYMENTTERMS", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("PAYMENTTERMS", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("PAYMENTTERMS", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("PAYMENTTERMS", "Delete");
