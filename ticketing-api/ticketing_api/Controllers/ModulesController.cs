...
namespace ticketing_api.Controllers
{
    ...
    public class ModulesController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("RESOURCES", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("RESOURCES", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("RESOURCES", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("RESOURCES", "Delete");
