...
{ 
    ...
    public class CustomersController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("CUSTOMERS", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("CUSTOMERS", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("CUSTOMERS", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("CUSTOMERS", "Delete");
