...
namespace ticketing_api.Controllers
{
    ...
    public class ProductCategoriesController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("CATEGORIES", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("CATEGORIES", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("CATEGORIES", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("CATEGORIES", "Delete");
