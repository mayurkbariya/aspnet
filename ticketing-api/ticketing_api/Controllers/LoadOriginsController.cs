...
namespace ticketing_api.Controllers
{
    ...
    public class LoadOriginsController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("LOADORIGIN", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("LOADORIGIN", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("LOADORIGIN", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("LOADORIGIN", "Delete");
