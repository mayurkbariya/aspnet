...
namespace ticketing_api.Controllers
{
    ...
    public class DriversController : IdentityBaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("DRIVERS", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("DRIVERS", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("DRIVERS", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("DRIVERS", "Delete");
