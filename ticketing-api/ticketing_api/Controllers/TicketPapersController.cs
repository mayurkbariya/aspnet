...
namespace ticketing_api.Controllers
{
    ...
    public class TicketPapersController : BaseController.BaseController
    {
        ...
        {
            var isPermisssion = await CheckPermissions("TICKETPAPERS", "Read");
        ...
        {
            var isPermisssion = await CheckPermissions("TICKETPAPERS", "Create");
        ...
        {
            var isPermisssion = await CheckPermissions("TICKETPAPERS", "Update");
        ...
        {
            var isPermisssion = await CheckPermissions("TICKETPAPERS", "Delete");
