...
namespace FBDropshipper.Persistence.Migrations
{
    ...
    [Migration("20220122110225_AddMarketplaceToInventory")]
    partial class AddMarketplaceToInventory
    {
            ...
            modelBuilder.Entity("FBDropshipper.Domain.Entities.MarketPlace", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("iX_marketPlaces_userId");
            ...
            modelBuilder.Entity("FBDropshipper.Domain.Entities.MarketPlace", b =>
                {
                    ...
                    b.HasOne("FBDropshipper.Domain.Entities.User", null)
                        .WithMany("MarketPlaces")
                        .HasForeignKey("UserId")
                        .HasConstraintName("fK_marketPlaces_users_UserId");
